...
(function (ErrorMessage) {
    ...
    ErrorMessage["INVALID_MODULES_DIRECTORIES"] = "Invalid modulesDirectories option. If defined, it should be a nonempty array of strings.";
    ErrorMessage["NO_MODULE_DIRECTORY_FOUND_FOR_MODULE"] = "Could not find package {0} in any module directory. Please check if this package exists in any of the directories defined by the modulesDirectories option.";
    ErrorMessage["BUILD_ROOT_NOT_EXIST"] = "Could not find the following specified build root: {0}";

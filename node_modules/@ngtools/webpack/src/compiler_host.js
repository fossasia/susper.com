...
var WebpackCompilerHost = (function () {
    ...
    WebpackCompilerHost.prototype.populateWebpackResolver = function (resolver) {
        ...
        for (var _i = 0, _a = this.getChangedFilePaths(); _i < _a.length; _i++) {
            var fileName = _a[_i];
        ...
        for (var _b = 0, _c = Object.keys(this._changedDirs); _b < _c.length; _b++) {
            var dirName = _c[_b];
    ...
    WebpackCompilerHost.prototype.readFile = function (fileName) {
        ...
        if (this._files[fileName] == null) {
            var result = this._delegate.readFile(fileName);

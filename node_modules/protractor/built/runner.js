...
var Runner = (function (_super) {
    ...
    Runner.prototype.setupGlobals_ = function (browser_) {
        ...
        ptor_1.protractor.ExpectedConditions = browser_1.ProtractorBrowser.ExpectedConditions;
    ...
    Runner.prototype.createBrowser = function (plugins) {
        ...
        var browser_ = browser_1.ProtractorBrowser.wrapDriver(driver, config.baseUrl, config.rootElement, config.untrackOutstandingTimeouts);

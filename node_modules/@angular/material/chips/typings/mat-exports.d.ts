 ...
 */
import { MdBasicChip, MdChip, MdChipBase, MdChipEvent, MdChipRemove } from './chip';
import { MdChipInput, MdChipInputEvent } from './chip-input';
import { MdChipList, MdChipListChange } from './chip-list';
import { MdChipsModule } from './chips-module';
...
export { MdChipListChange as MatChipListChange };

...
import { GestureConfig, MATERIAL_COMPATIBILITY_MODE, MdCommonModule, MdRipple, MdRippleModule, applyCssTransform, mixinColor, mixinDisableRipple, mixinDisabled, mixinTabIndex } from '@angular/material/core';
...
class MdSlideToggle extends _MdSlideToggleMixinBase {
    ...
    constructor(elementRef, renderer, _platform, _focusMonitor, _changeDetectorRef, tabIndex) {
        ...
        this.onChange = (_) => { };
        this.onTouched = () => { };
        this._uniqueId = `md-slide-toggle-${++nextUniqueId}`;

...
function getAppFromConfig(nameOrIndex) {
    ...
    if (!apps) {
        throw new SilentError(chalk_1.default.red('Unable to find any apps in `.angular-cli.json`.'));
    }
    if (nameOrIndex) {
    ...
    throw new SilentError(chalk_1.default.red(common_tags_1.oneLine `
...
//# sourceMappingURL=/users/hansl/sources/hansl/angular-cli/utilities/app-utils.js.map
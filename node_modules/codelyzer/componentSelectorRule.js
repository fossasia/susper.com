...
var Rule = (function (_super) {
    ...
    Rule.prototype.getStyleFailure = function () { return 'The selector of the component "%s" should be named %s (https://goo.gl/mBg67Z)'; };
    Rule.prototype.getPrefixFailure = function (prefixes) {
        if (prefixes.length === 1) {
            return 'The selector of the component "%s" should have prefix "%s" (https://goo.gl/cix8BY)';
        }
        else {
            return 'The selector of the component "%s" should have one of the prefixes "%s" (https://goo.gl/cix8BY)';
        }
    };
    return Rule;
